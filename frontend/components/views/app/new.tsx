...
type UploadFiles = { name: string; size: string; type: "PDF" } | undefined;
...
export default function Upload() {
    ...
    const [uploadFiles, setUploadFiles] = useState<UploadFiles>(undefined);
                ...
                <Card className="w-full max-w-xl mt-4 mx-auto">
                    <CardContent>
                        <form onSubmit={handleSubmit}>
                            <FieldGroup className="h-90 flex flex-col gap-8">
                                <Field
