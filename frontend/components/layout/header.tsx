                    ...
                    <Sheet open={open} onOpenChange={setOpen}>
                        <div className="h-full flex items-center justify-between">
                            ...
                            <SheetTrigger>
                                ...
                                >
                                    <span className="w-full h-[2.5px] absolute top-1/2 left-1/2 -translate-x-1/2 translate-y-[-4.75px] bg-white rounded-none transition-transform duration-250 group-data-[open]/menu:translate-y-0 group-data-[open]/menu:rotate-45" />
                                    <span className="w-full h-[2.5px] absolute top-1/2 left-1/2 -translate-x-1/2 translate-y-[+4.75px] bg-white rounded-none transition-transform duration-250 group-data-[open]/menu:translate-y-0 group-data-[open]/menu:-rotate-45" />
                                </div>
                            </SheetTrigger>
                        </div>
